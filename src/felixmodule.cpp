...
/*
 * There are three scenarios, in which Felixmodule can be loaded by NEST:
 *
...
felixmodule::Felixmodule felixmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

felixmodule::Felixmodule::Felixmodule()
{
#ifdef LINKED_MODULE
...
felixmodule::Felixmodule::~Felixmodule() = default;

const std::string
felixmodule::Felixmodule::name() const
{
  return std::string( "Felix Module" ); // Return name of the module
}

//-------------------------------------------------------------------------------------

void
felixmodule::Felixmodule::init( SLIInterpreter* i )
{
  ...
  */
  ...
  //nest::kernel().model_manager.register_node_model< nest::poisson_generator >( "poisson_generator" );
  ...
  */
  //nest::register_connection_model< felixmodule::abs_synapse >( "abs_synapse" );
